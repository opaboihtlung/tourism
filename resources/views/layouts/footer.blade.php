<div class="w-full bg-charcoal-black text-whitish-gray">
  <div class="grid grid-cols-1 p-4 sm:grid-cols-2 md:grid-cols-5">
    ...
    <div class="p-6">
      ...
      <ul>
        ...
        <li class="mt-2 hover:cursor-pointer hover:text-tourism-green">
          <a href="{{ Route('placesToVisit') }}">
            Place to Visit
          </a>
        </li>
        <li class="mt-2 hover:cursor-pointer hover:text-tourism-green">
          <a href="{{ Route('thingsToDoList') }}">
            Things to Do
          </a>
        </li>
        <li class="mt-2 hover:cursor-pointer hover:text-tourism-green">
          <a href="{{ Route('planYourTrip') }}">
            Plan your Trip
          </a>
        </li>
        <li class="mt-2 hover:cursor-pointer hover:text-tourism-green">
    ...
    <div class="p-6">
      ...
      <div class="flex flex-row">
        <div class="flex-col">
          {{-- <a href="https://play.google.com/store/apps/details?id=com.mizoram.tourism_app"> --}}
          <a href="">
            <img src="/image/playstore.png" alt="playstore" class="object-contain mt-4">
          </a>
        </div>
        <div class="flex-col">
          {{-- <a href="https://apps.apple.com/in/app/tourism-mizoram/id1621945709"> --}}
          <a href="">
  ...
  <div class="grid p-4 md:grid-cols-2 sm:grid-cols-1">
    <div class="flex-col p-6 mt-auto mb-auto">
       © {{ date('Y') }} Mizoram Tourism. All rights reserved
    </div>
    <div class="flex-col">
