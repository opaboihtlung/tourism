<template>
  <div class="container mt-10 px-8">
    ...
    <div>
      ...
      <!-- <button href="#" @click="stateChange">Click</button> -->
    </div>
...
export default {
  data() {
    return {
      data: {},
      role1:this.$store.getters.getRole,
      hasLoading:true
    };
  },
  created() {
    ...
    this.role1 =this.$store.getters.getRole;
   },
  methods : {
    stateChange(){
      this.$store.dispatch("changeRole","WAZA!");
      this.role1 =this.$store.getters.getRole;
    }
  },
  computed: {
