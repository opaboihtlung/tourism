<template>
    <div class="container mt-10  px-8  ">
      ...
      <div class="mb-6 text-black text-2xl mx-2 font-semibold">Informations</div>

        <div>
            <router-link 
        :to="{ name: 'informationCreate' }"
                      ...
                      <tbody class="bg-white">
                          <tr v-for="(value,index) in data" :key="value.name">
                              ...
                              <td
                                  ...
                                  <router-link :to="{ name:'informationEdit',params:{id:value.id}}" class="text-indigo-400 hover:text-indigo-900" > Edit</router-link>
                              </td>
                          </tr>
...
export default {
  ...
  created() {
    ...
    axios.get("/api/informations").then((result) => {
