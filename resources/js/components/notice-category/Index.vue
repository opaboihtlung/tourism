<template>
    <div class="container mt-10  px-8  ">
      ...
      <div class="mb-6 text-black text-2xl mx-2 font-semibold">Notice Category  </div>
                          ...
                          <tr v-for="(value,index) in data" :key="value.name">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                              ...
                              <td
                                  ...
                                  <router-link :to="{ name:'categoriesEdit',params:{id:value.id}}" class="text-indigo-400 hover:text-indigo-900" > Edit</router-link>
                              </td>
                          </tr>
