<template>
    <div class="">
        ...
        <div class="bg-white border border-gray-300 ml-5 p-8 px-24 w-200">
            <div class="flex">
                <div class="mb-6 text-black text-2xl mx-2 font-semibold">Edit Mizoram</div>
                <div class="col-end-3">
            ...
            <!-- <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    <label for="image" class="form-label inline-block mb-2 text-gray-700"
                    >Image</label
                    >
                    <input
                    type="text"
...
export default {
  data(){
    ...
    methods: {
        updateModel(){
            axios.put("/api/mizoram/"+this.id,this.data).then((result) => {
            console.log(result.data.name);
        ...
        deleteModel(){
            if(confirm("Do you really want to delete?")){
                ...
                axios.delete("/api/mizoram/"+this.id).then((result) => {
                console.log(result.data.name);
                if(result.status==200){
                    this.$router.push('./')
                }
