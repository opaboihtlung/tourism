<template>
    <div class="">
        <button class="mt-20 ml-5"  onclick="history.back()">Go Back</button>

        <div class="bg-white border border-gray-300   ml-5 p-8 px-24 w-200">

            <div class="mb-6 text-black text-2xl mx-2 font-semibold">Create About us</div>
            
            <div>
                     
                    <div class="flex">
                        <div class="mb-3 xl:w-96">
                            <label for="things_to_do" class="form-label inline-block mb-2 text-gray-700">
                                Things to do
                            </label>
                            <input
                            type="text"
  ...
  data(){
    ...
    methods: {
        createModel(){
            ...
            this.mAbout.images = this.ImageData

          axios.post('/api/abouts',this.mAbout)
          .then(response=>{
