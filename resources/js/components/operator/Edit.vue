<template>
    <div class="">
        ...
        <div class="bg-white border border-gray-300 ml-5 p-8 px-24 w-200">
            <div class="flex">
                <div class="mb-6 text-black text-2xl mx-2 font-semibold">Edit Operator</div>
                <div class="col-end-3">
...
export default {
  data(){
    ...
    created() {
        ...
        axios.get("/api/operators/"+this.id).then((result) => {
    ...
    methods: {
        updateModel(){
            axios.put("/api/operators/"+this.id,this.data).then((result) => {
            console.log(result.data.name);
        ...
        deleteModel(){
            if(confirm("Do you really want to delete?")){
                ...
                axios.delete("/api/operators/"+this.id).then((result) => {
                console.log(result.data.name);
                // this.data = result.data.data;
                if(result.status==200){
                    this.$router.push('./')
