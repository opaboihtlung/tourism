<template>
    <div class="">
        ...
        <div class="bg-white border border-gray-300 ml-5 p-8 px-24 w-200">
            <div class="flex">
                <div class="mb-6 text-black text-2xl mx-2 font-semibold">Edit Restaurant</div>
                <div class="col-end-3">
            ...
            <div>
                 ...
                 <div class="flex">
                    ...
                    <div class="flex">
                        <div class="mb-3 xl:w-96">
                            <label for="license" class="form-label inline-block mb-2 text-gray-700">
                                License
                            </label>
                            <input
                            type="text"
...
export default {
  data(){
    ...
    created() {
        ...
        axios.get("/api/restaurants/"+this.id).then((result) => {
        console.log(result.data.name);
            this.data.name = result.data.name;
            this.data.license = result.data.license;
    ...
    methods: {
        updateModel(){
            axios.put("/api/restaurants/"+this.id,this.data).then((result) => {
            console.log(result.data.name);
        ...
        deleteModel(){
            if(confirm("Do you really want to delete?")){
                ...
                axios.delete("/api/restaurants/"+this.id).then((result) => {
                console.log(result.data.name);
                // this.data = result.data.data;
                if(result.status==200){
                    this.$router.push('./')
