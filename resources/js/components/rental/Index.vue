<template>
    <div class="container mt-10  px-8  ">
      ...
      <div class="mb-6 text-black text-2xl mx-2 font-semibold">Rental</div>

        <div>
            <router-link 
        :to="{ name: 'rentalCreate' }"
      ...
      <div class="flex flex-col mt-8">
          <div class="overflow-x-auto -my-2 py-2 sm:-mx-6 overflow-x-auto sm:px-6 lg:-mx-8 lg:px-8 overflow-x-auto">
              <div
                          ...
                          <tr v-for="(value,index) in data" :key="value.name">
                              ...
                              <td
                                  class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                   <router-link :to="{ name:'rentalEdit',params:{id:value.id}}" class="text-indigo-400 hover:text-indigo-900" > Edit</router-link>
                              </td>
                          </tr>
...
export default {
  ...
  created() {
    ...
    axios.get("/api/rentals").then((result) => {
