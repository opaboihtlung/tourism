<template>
    <div class="container mt-10  px-8  ">
      ...
      <div class="mb-6 text-black text-2xl mx-2 font-semibold">Notice Category List</div>

        <div>
            <router-link 
        :to="{ name: 'categoryCreate' }"
             style="background:#24b897" class=" rounded-full font-bold text-white  px-4 py-3 ">
          Create Category for Notice
            </router-link>
        </div>
                      ...
                      <tbody class="bg-white">
                          <tr v-for="(value,index) in data" :key="value.name">
                              ...
                              <td
                                  ...
                                  <router-link :to="{ name:'categoryEdit',params:{id:value.id}}" class="text-indigo-400 hover:text-indigo-900" > Edit</router-link>
                              </td>
                          </tr>
