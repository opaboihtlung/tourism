<template>
    <div class="">
        ...
        <div class="bg-white border border-gray-300  ml-5 p-8 px-24 w-200">
            <div class="mb-6 text-black text-2xl mx-2 font-semibold">Create User</div>
            ...
            <div>
                    ...
                    <div>
                        <div class="mb-3 xl:w-96">
                            <label for="password_confirmed" class="form-label inline-block mb-2 text-gray-700">
                               Confirm Password
                            </label>
                            <input
                            type="text"
                    ...
                    <div>
                        <div class="mb-3 xl:w-96">
                            <label for="role" class="form-label inline-block mb-2 text-gray-700">
                                Role
                            </label>
...
export default {
  data(){
    return{
      ...
      roles:['citizen','hotel','lodge','admin'],
      mToast:false,
